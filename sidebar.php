<aside id="sidebar">
    ...
    <section>
        <a href="<?php echo esc_url(get_random_post_link()); ?>">
            <img class="doodle-separator doodle-9"
                src="<?php echo get_template_directory_uri(); ?>/assets/css/img/doodles/notehasard.png" />
        </a>
    ...
    <section class="sidebar-section">
        <p>
            <a class="flex-icon" href="<?php bloginfo('rss2_url'); ?>" title="Flux RSS des articles" target="_blank">
                <img class="social-link-item"
                    src="<?php echo get_template_directory_uri(); ?>/assets/css/img/rss-icon.png" alt="RSS Articles">
                <span>Flux RSS des articles</span>
            </a>
        </p>
        <p>
            <a class="flex-icon" href="<?php bloginfo('comments_rss2_url'); ?>" title="Flux RSS des commentaires"
                target="_blank">
                <img class="social-link-item"
                    src="<?php echo get_template_directory_uri(); ?>/assets/css/img/rss-icon.png"
